...
const Header = ({setHidenNotis, hidenNotis, search, setSearch, hidden, setHidden}) => {
            ...
            <ul className="flex justify-center gap-10 text-md font-bold text-white">
                ...
                <li>
                    ...
                    <div className="flex flex-col relative">
                        ...
                        >{profile?.userName} <IoMdArrowDropdown className="inline"/></p> 
                        { open && <div className="border-1 rounded-1 border-yellow-400 fixed top-14 flex flex-col pt-1 pb-2 px-3 bg-purple-600">
                            <Link 
                            to="/profile" 
