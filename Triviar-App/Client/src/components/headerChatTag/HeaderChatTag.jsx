const HeaderChatTag = ({
  ...
  return (
    <div className="d-flex justify-start gap-1 p-2  bg-dark rounded text-xs md:text-md w-full overflow-x-hidden">
      <span
      ...
      {userMsgPriv.length > 0 &&
        userMsgPriv.map((priv) => {
          return (
            <div
              className="d-flex px-1 font-semibold bg-sky-600 text-orange-300 rounded-1 border-1 border-sky-300 overflow-scroll-auto cursor-pointer"
              key={priv.userId}
            >
