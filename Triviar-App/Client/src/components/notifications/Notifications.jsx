...
const Notifications = ({ setHidenNotis, hidenNotis }) => {
  ...
  const filterNotifications = () => {
    setFilterNotis(
      notificationsGame.filter(
        (noti) => noti.userIdInvitation === userId || noti.userId === userId
      )
    );
  };
                ...
                {!noti.checked && userId === noti.userIdInvitation && (
                  ...
                  >
                    <div className="text-white">
                      <p className="mb-2 text-gray-500 text-bold">{`${noti.userName} te invito a jugar`}</p>
                      <button
                      ...
                      <button
                        ...
                        onClick={() =>
                          deleteNoti(noti._id, setHidenNotis(!hidenNotis))
                        }
                      >
                        Rechazar
                      </button>
