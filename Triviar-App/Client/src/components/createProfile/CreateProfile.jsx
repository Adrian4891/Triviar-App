...
const CreateProfile = () => {
    const img = "https://waterfordwhispersnews.com/wp-content/uploads/2021/02/dicap.jpg"
    ...
    const postProfileUser = async () => {
        try {
           const { data } = await axios.post(`${URL_BASE}/profile/${userId}`, userData);
           return data;
        } catch(error){
