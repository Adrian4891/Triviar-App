const FormSiSu = ({ userData, handleInp, handleSubmit, error }) => {
  return (
    <form
      className="d-flex justify-center flex-col gap-3 pt-5 pb-2"
    ...
    >
      <fieldset className="d-flex justify-center flex-col border-1">
        ...
        <input
          ...
          onChange={handleInp}
        />
        <p className="pt-2 text-xs text-red-600">{error?.email}</p>
      </fieldset>
      <fieldset className="d-flex justify-center flex-col">
        ...
        <input
          ...
          onChange={handleInp}
        />
        <p className="pt-2 text-xs text-red-600">{error?.password}</p>
      </fieldset>
      <input
        type="submit"
