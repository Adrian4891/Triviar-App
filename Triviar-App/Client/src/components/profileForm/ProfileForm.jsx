...
const ProfileForm = ({userData, error, handleInput, handleSubmit, errorPost, getCountries, countries}) => {
   return(
        <form 
        ...
        >
            <fieldset>
                ...
                ${error.userName ? " focus:outline-none focus:ring-1 focus:ring-red-500" 
                ...
                />
                {error.userName && <p className="text-sm text-red-500 p-1">
                    {error.userName}
                </p>}
                {errorPost && <p className="text-sm text-red-500 p-1">
                    {errorPost}
                </p>}
            </fieldset>
            <fieldset>
                ...
                onChange={handleInput}
                className={`inline-block w-72 py-1 px-3 rounded-2  border border-zinc-300 text-zinc-500 font-semi-bold
                ${error.country ? " focus:outline-none focus:ring-1 focus:ring-red-500" 
                : "focus:outline-none focus:ring-1 focus:ring-green-500"} 
            `}
                >
            ...
            <fieldset>
                ...
                ${error.birthday ? " focus:outline-none focus:ring-1 focus:ring-red-500" 
                : "focus:outline-none focus:ring-1 focus:ring-green-500"} 
            `}
                type="date"
                ...
                onChange={handleInput}
                />
                {error.birthday && <p className="text-sm text-red-500 p-1">
                    {error.birthday}
                </p>}
            </fieldset>
            <button
