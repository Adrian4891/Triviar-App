                    ...
                    players.map((player)=> {
                        return(
                            ...
                            <div key={player?._id} className="flex flex-col items-center">
                                <h3 className=" md:text-xl text-white font-bold p-2">{player?.userName}</h3>
                                <img src={player?.picture} alt="" className=" w-24 h-24 fit-content rounded-full"/>
                                <h2 className=" md:text-xl text-white font-bold p-2">{player?.points}</h2>
                            </div>
                        )
                    })
                }  
